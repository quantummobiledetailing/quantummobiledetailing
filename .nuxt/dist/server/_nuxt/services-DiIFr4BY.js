...
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderVNode, ssrRenderTeleport } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--><article class="glow-card flex h-full flex-col rounded-3xl p-6 sm:col-span-2 lg:col-span-1 lg:col-start-3"><p class="text-xs uppercase tracking-[0.4em] text-brand-primary/80">Add-ons</p><div class="mt-4 grid gap-4 sm:grid-cols-2"><!--[-->`);
      ...
      _push(`<!--]--></div></article></section><section class="mx-auto max-w-6xl"><article class="glow-card rounded-3xl p-6"><p class="text-xs uppercase tracking-[0.4em] text-brand-primary/80">Process Breakdown</p><div class="mt-6 grid gap-6 md:grid-cols-3"><!--[-->`);
...
//# sourceMappingURL=services-DiIFr4BY.js.map
