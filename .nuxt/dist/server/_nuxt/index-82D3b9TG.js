...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const testimonials = [
      ...
      {
        name: "Eric Farrell",
        quote: "I couldn�?Tt be happier with Ryan�?Ts work! He�?Ts professional, detail-oriented, and clearly takes pride in what he does. If you�?Tre looking for a trustworthy local car detailer, this is the place to go."
      },
      {
        name: "Austen Tanner",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></section><section class="px-6 sm:px-10 reveal" data-reveal><div class="mx-auto grid max-w-6xl gap-6 md:grid-cols-3"><!--[-->`);
...
//# sourceMappingURL=index-82D3b9TG.js.map
