...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderTeleport, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-C6EbPEYs.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C8i1VBSc.js")
  },
  {
    name: "booking",
    path: "/booking",
    component: () => import("./_nuxt/booking-Cgl0bFWu.js")
  },
  {
    name: "gallery",
    path: "/gallery",
    component: () => import("./_nuxt/gallery-CvBKFdB8.js")
  },
  {
    name: "services",
    path: "/services",
    component: () => import("./_nuxt/services-BZfxr93X.js")
  }
];
