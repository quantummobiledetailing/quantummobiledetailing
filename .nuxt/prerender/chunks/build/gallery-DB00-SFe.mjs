...
import { defineComponent, ref, computed, watch, mergeProps, unref, useSSRContext } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderClass, ssrRenderStyle } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/vue/server-renderer/index.mjs';
...
const __vite_glob_0_0 = "" + buildAssetsURL("10_Chevrolet_Silverado_Side_Driver.B5TnwsOc.png");
const __vite_glob_0_1 = "" + buildAssetsURL("11_Chevrolet_Silverado_Scratch_Door.Vj-_gM5S.png");
const __vite_glob_0_2 = "" + buildAssetsURL("12_Chevrolet_Silverado_Engine_Bay.B8w7krdL.png");
const __vite_glob_0_3 = "" + buildAssetsURL("13_Chevrolet_Silverado_Gas_Cap.CFMyfuuz.png");
const __vite_glob_0_4 = "" + buildAssetsURL("14_Chevrolet_Silverado_Driver_Seat.Cyg9QfDW.png");
const __vite_glob_0_5 = "" + buildAssetsURL("15_Chevrolet_Silverado_Back_Seat.DT9htEfz.png");
const __vite_glob_0_6 = "" + buildAssetsURL("16_Jeep_Liberty_driver.ByD_XI71.png");
const __vite_glob_0_7 = "" + buildAssetsURL("17_Jeep_Liberty_trunk_open.DdvzTL_s.png");
const __vite_glob_0_8 = "" + buildAssetsURL("18_Jeep_Liberty_floor_mat.CsXPH-0s.png");
const __vite_glob_0_9 = "" + buildAssetsURL("19_Jeep_Liberty_seat_closeup.DSdjZ2Ra.png");
const __vite_glob_0_10 = "" + buildAssetsURL("1_Subaru_Legacy_Hood.CiZqHJoN.png");
const __vite_glob_0_11 = "" + buildAssetsURL("20_Jeep_Liberty_back.at9iaaY3.png");
const __vite_glob_0_12 = "" + buildAssetsURL("21_Jeep_Liberty_passenger.Cmv1RLqx.png");
const __vite_glob_0_13 = "" + buildAssetsURL("22_Jeep_Liberty_trunk_closed.adrdi3TO.png");
const __vite_glob_0_14 = "" + buildAssetsURL("23_Subaru_Ascent_Front.DCn0nux9.png");
const __vite_glob_0_15 = "" + buildAssetsURL("24_Subaru_Ascent_Side.D-2e_yY_.png");
const __vite_glob_0_16 = "" + buildAssetsURL("25_Subaru_Forester_Back.CM0sH4Ht.png");
const __vite_glob_0_17 = "" + buildAssetsURL("26_Subaru_Forester_Back_Seat.DecpOmAZ.png");
const __vite_glob_0_18 = "" + buildAssetsURL("27_Subaru_Forester_Driver.YCnNUDuV.png");
const __vite_glob_0_19 = "" + buildAssetsURL("28_Subaru_Forester_Driver_back.83LEvxFV.png");
const __vite_glob_0_20 = "" + buildAssetsURL("29_Subaru_Forester_Trunk.SfQGkJnp.png");
const __vite_glob_0_21 = "" + buildAssetsURL("2_Subaru_Legacy_Roof.Ct-7l7el.png");
const __vite_glob_0_22 = "" + buildAssetsURL("30_Subaru_Forester_Dash.CcGpZJmq.png");
const __vite_glob_0_23 = "" + buildAssetsURL("31_Volvo_SUV_Driver.slbQPS7Q.png");
const __vite_glob_0_24 = "" + buildAssetsURL("32_Volvo_SUV_Side.Bn1fRQHk.png");
const __vite_glob_0_25 = "" + buildAssetsURL("33_Volvo_SUV_Trunk.D0LepoZC.png");
const __vite_glob_0_26 = "" + buildAssetsURL("34_Volvo_SUV_Headlight.DlpN0hEc.png");
const __vite_glob_0_27 = "" + buildAssetsURL("35_Subaru_STI_Side.BlmuoxpH.png");
const __vite_glob_0_28 = "" + buildAssetsURL("36_Subaru_STI_Back_Left.efBE2DbS.png");
const __vite_glob_0_29 = "" + buildAssetsURL("37_Subaru_STI_Back_Right.ChjAXGh0.png");
const __vite_glob_0_30 = "" + buildAssetsURL("38_Subaru_STI_Passenger.BpYh0BJR.png");
const __vite_glob_0_31 = "" + buildAssetsURL("39_Subaru_STI_Trunk.CzWnayQb.png");
const __vite_glob_0_32 = "" + buildAssetsURL("3_Subaru_Legacy_Console.DVQrnrvb.png");
const __vite_glob_0_33 = "" + buildAssetsURL("40_Hyundai_Palisade_Front.DEf-fgB4.png");
const __vite_glob_0_34 = "" + buildAssetsURL("41_Hyundai_Palisade_Side_Left.Bm_YmfTT.png");
const __vite_glob_0_35 = "" + buildAssetsURL("42_Hyundai_Palisade_Side_Right.CTxfLPa7.png");
const __vite_glob_0_36 = "" + buildAssetsURL("43_Hyundai_Palisade_Rear.CtZ8gbr7.png");
const __vite_glob_0_37 = "" + buildAssetsURL("44_Hyundai_Palisade_Tire.CZcwFUhk.png");
const __vite_glob_0_38 = "" + buildAssetsURL("45_GMC_Sierra_Front.gym1nhlN.png");
const __vite_glob_0_39 = "" + buildAssetsURL("46_GMC_Sierra_Side.DxLPTM_M.png");
const __vite_glob_0_40 = "" + buildAssetsURL("47_GMC_Sierra_Bed.CO45NHh0.png");
const __vite_glob_0_41 = "" + buildAssetsURL("48_Ford_F350_Front.CSrH57J_.png");
const __vite_glob_0_42 = "" + buildAssetsURL("49_Ford_F350_Side._pIBo0S7.png");
const __vite_glob_0_43 = "" + buildAssetsURL("4_Subaru_Legacy_driver.ChRFtMpA.png");
const __vite_glob_0_44 = "" + buildAssetsURL("50_Ford_F350_Bed.o-d3Ebqw.png");
const __vite_glob_0_45 = "" + buildAssetsURL("51_Mazda_CX50_Front.DY3KKZhb.png");
const __vite_glob_0_46 = "" + buildAssetsURL("52_Mazda_CX50_Side.Dn6Tudwj.png");
const __vite_glob_0_47 = "" + buildAssetsURL("53_Mazda_CX50_Rear.DLR6TUYY.png");
const __vite_glob_0_48 = "" + buildAssetsURL("54_Toyota_Yaris_Front.B0wsRFmm.png");
const __vite_glob_0_49 = "" + buildAssetsURL("55_Toyota_Yaris_Rear.BFDmVUoH.png");
const __vite_glob_0_50 = "" + buildAssetsURL("56_Dodge_Challenger_Dash.ugAkKOAH.png");
const __vite_glob_0_51 = "" + buildAssetsURL("57_Dodge_Challenger_Driver.D-qFu_tk.png");
const __vite_glob_0_52 = "" + buildAssetsURL("58_Dodge_Challenger_Front.CwZqsYFe.png");
const __vite_glob_0_53 = "" + buildAssetsURL("59_Dodge_Challenger_Side.CjwNxGfn.png");
const __vite_glob_0_54 = "" + buildAssetsURL("5_Subaru_Legacy_driver_door.D3tkVNTg.png");
const __vite_glob_0_55 = "" + buildAssetsURL("6_Subaru_Legacy_passenger.BY8Xy1vd.png");
const __vite_glob_0_56 = "" + buildAssetsURL("7_Subaru_Legacy_back.Bnk8U7F8.png");
const __vite_glob_0_57 = "" + buildAssetsURL("8_Subaru_Legacy_trunk.CtdTkyT4.png");
const __vite_glob_0_58 = "" + buildAssetsURL("9_Chevrolet_Silverado_Rear_Side.DuERJyTz.png");
const __vite_glob_0_59 = "" + buildAssetsURL("Toyota_Sienna_After.DQoXykcx.jpg");
const __vite_glob_0_60 = "" + buildAssetsURL("Toyota_Sienna_Before.CGu6o0hL.jpg");
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const galleryModules = /* @__PURE__ */ Object.assign({
      ...
      "/assets/gallery/Toyota_Sienna_After.jpg": __vite_glob_0_59,
      "/assets/gallery/Toyota_Sienna_Before.jpg": __vite_glob_0_60
    });
    ...
    const normalizeName = (value) => value.toLowerCase().replace(/\.[^/.]+$/, "").replace(/[-_]+/g, " ").replace(/\s+/g, " ").trim();
    const featuredOrder = {
    ...
    const shots = Object.entries(galleryModules).sort(([pathA], [pathB]) => {
      var _a, _b, _c, _d;
      const nameA = normalizeName((_a = pathA.split("/").pop()) != null ? _a : "");
      const nameB = normalizeName((_b = pathB.split("/").pop()) != null ? _b : "");
      const priorityA = (_c = featuredOrder[nameA]) != null ? _c : Number.MAX_SAFE_INTEGER;
      const priorityB = (_d = featuredOrder[nameB]) != null ? _d : Number.MAX_SAFE_INTEGER;
      ...
      return {
        title: (_b = featuredTitle[normalizedName]) != null ? _b : prettyTitle,
        image: src,
        key: normalizedName
      };
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(activeShot)) {
          _push2(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4"><button type="button" class="absolute right-6 top-6 rounded-full border border-white/30 bg-slate-950/70 px-4 py-2 text-xs uppercase tracking-[0.3em] text-white"> Close </button><div class="${ssrRenderClass([unref(zoomContainerClass), "max-h-[85vh] w-full max-w-5xl overflow-hidden touch-none"])}"><img${ssrRenderAttr("src", unref(activeShot).image)}${ssrRenderAttr("alt", unref(activeShot).title)} class="${ssrRenderClass([unref(zoomImageClass), "h-full w-full select-none origin-top-left rounded-2xl object-contain shadow-2xl"])}" style="${ssrRenderStyle({ transform: `translate(${unref(pan).x}px, ${unref(pan).y}px) scale(${unref(zoom)})` })}" draggable="false"></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
//# sourceMappingURL=gallery-DB00-SFe.mjs.map
