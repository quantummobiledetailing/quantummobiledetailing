...
import { getContext, executeAsync } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/vue-router/vue-router.node.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/ryand/quantummobiledetailing/quantummobiledetailing/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-C-FOCcRE.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dq7K_X-A.mjs')
  },
  {
    name: "booking",
    path: "/booking",
    component: () => import('./booking-DdPDTwMB.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
  ...
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-7iF3d2h6.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-sD9Hjkcf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DEOD47jj.mjs'));
