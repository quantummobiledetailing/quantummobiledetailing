...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></section><section class="mx-auto max-w-5xl rounded-3xl border border-brand-primary/40 bg-slate-900/40 p-8 text-center reveal" data-reveal><p class="text-xs uppercase tracking-[0.4em] text-brand-primary/80">Join The Route</p><h2 class="mt-3 text-3xl font-semibold text-white">Ready for the Quantum experience?</h2><p class="mt-3 text-sm text-slate-300"> Email <a class="text-brand-primary underline" href="mailto:quantummobiledetailingllc@gmail.com">quantummobiledetailingllc@gmail.com</a> or call (541) 501-0698 to grab a slot on this week&#39;s schedule. </p><div class="mt-6 flex flex-wrap justify-center gap-4"><button type="button" class="btn-primary">Call For Consultation</button>`);
...
//# sourceMappingURL=about-BOfXnbk1.mjs.map
